    ...
    stages {
        stage('Build Test Deploy') {
            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME python -c "import pandas; import numpy; import scipy; import sklearn; import twint; import matplotlib; import seaborn"'
